...
\definecolor{hutton}{RGB}{0,08,65}
\definecolor{huttonlite}{RGB}{255,255,255}
\usepackage{color}
...
\begin{frame}       
 \frametitle{PROGRAMMING IN HASKELL}
    \begin{figure}
    \begin{tikzpicture}
        \node (main) at (0,0){\includegraphics[width=.9\textwidth]{img/b-lambda-calculus.png}};
...
\setbeamercolor{normal text}{bg=huttonlite}
